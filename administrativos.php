        ...
        <table id="tablax" class="table table-striped table-bordered" style="width:100%"  >
            ...
            <tbody>
                    ...
                    while ($registroDocumentos = $resDocumentos->fetch_array(MYSQLI_BOTH))
				{
					...
					echo'<tr>
			            ...
			            <td><a href="manuales/'.$registroDocumentos['ruta'].'">
                                   <button>ver</button>
                                </a></td>
                        <td> <embed src="manuales/'.$registroDocumentos['ruta'].'" type="application/pdf">
                        <button>ver</button></embed></td>


                           <td> <button id="btn-abrir-popup" class="btn-abrir-popup">Abrir </button></td>
			...
			<div class="popup" id="popup">
				...
				<iframe id="inlineFrameExample"
						...
						src="manuales/'.$registroDocumentos['ruta'].'">
				</iframe>
